...
public class MDPREditDiseaseRecovery extends BaseClass  {

  @Test
	public void MDPREditDiseaseRecovery() throws Exception {
		...
		ReadExcel.setExcelFile(Global.fileLocation+"MDPRequest.xls","MDPRDiseaseEdit");
