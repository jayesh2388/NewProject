...
public class MDPRCreateDiseaseRecovery extends BaseClass  {

  @Test
	public void MDPRCreateDiseaseRecovery() throws Exception {
		TestExecution exeKey = new TestExecution();
		Properties prop;
		prop = new Properties();
		System.out.println("started MDPRCreateDiseaseRecovery");
		...
		ReadExcel.setExcelFile(Global.fileLocation+"MDPRequest.xls","MDPRDiseaseNew");
