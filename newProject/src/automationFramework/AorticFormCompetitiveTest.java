...
public class AorticFormCompetitiveTest extends BaseClass  {

  @Test
	public void AorticFormCompetitive() throws Exception {
		...
		ReadExcel.setExcelFile(Global.fileLocation+"testCaseSheet.xls","AorticFormCompetitive");
