...
public class AFSFormTest extends BaseClass  {

  @Test
	public void AFSForm() throws Exception {
		TestExecution exeKey = new TestExecution();
		Properties prop;
		prop = new Properties();
//		System.out.println("jUST STARTED");
		
//		System.out.println("DEFINED REPORT");
		...
		ReadExcel.setExcelFile(Global.fileLocation,"AFSForm");
