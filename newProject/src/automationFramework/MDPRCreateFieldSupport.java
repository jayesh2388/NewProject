...
public class MDPRCreateFieldSupport extends BaseClass  {

  @Test
	public void MDPRCreateFieldSupport() throws Exception {
		TestExecution exeKey = new TestExecution();
		Properties prop;
		prop = new Properties();
		 System.out.println("started MDPRCreateFieldSupport");
		...
		ReadExcel.setExcelFile(Global.fileLocation+"MDPRequest.xls","MDPRFieldSupportNew");
