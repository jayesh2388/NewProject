...
public class CCCaseEscalationToDevelopment extends BaseClass  {

  @Test
	public void CCCaseEscalationToDevelopment() throws Exception {
		TestExecution exeKey = new TestExecution();
		Properties prop;
		prop = new Properties();
		 System.out.println("started AF1");
		 
		 System.out.println("Repor AF2");
		...
		ReadExcel.setExcelFile(Global.fileLocation,"CCCaseEscalationDevelopment");
