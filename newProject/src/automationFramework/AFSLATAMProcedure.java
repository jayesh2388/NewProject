...
public class AFSLATAMProcedure extends BaseClass  {

  @Test
	public void AFSLATAMProcedure() throws Exception {
		...
		ReadExcel.setExcelFile(Global.fileLocation,"AFSLATAMProcedure");
