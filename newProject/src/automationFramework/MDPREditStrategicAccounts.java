...
public class MDPREditStrategicAccounts extends BaseClass  {

  @Test
	public void MDPREditStrategicAccounts() throws Exception {
		TestExecution exeKey = new TestExecution();
		Properties prop;
		prop = new Properties();
		 System.out.println("started MDPREditStrategicAccounts");
		...
		ReadExcel.setExcelFile(Global.fileLocation+"MDPRequest.xls","MDPRStrategicAccountsEdit");
