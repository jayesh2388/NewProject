...
public class MDPRCreateStrategicAccounts extends BaseClass  {

  @Test
	public void MDPRCreateStrategicAccounts() throws Exception {
		TestExecution exeKey = new TestExecution();
		Properties prop;
		prop = new Properties();
		 System.out.println("started MDPRCreateStrategicAccounts");
		...
		ReadExcel.setExcelFile(Global.fileLocation+"MDPRequest.xls","MDPRStrategicAccountsNew");
